...
// --- Begin: B2B Partner End Users Leads Schema --- //
const schema = new Schema({
  ...
  priority: {type: String, required: false}, // Number: 031(Low), 051(Medium), 071(High)
...
schema.index({priority: -1, uDtStr: -1});

module.exports = mongoose.model(config.collB2BEuLeads, schema);
// --- End: B2B Partner End Users Leads Schema --- //
