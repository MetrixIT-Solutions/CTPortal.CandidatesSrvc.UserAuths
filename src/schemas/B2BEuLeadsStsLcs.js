...
// --- Begin: B2B Partner End Users Leads Status Lifecycles Schema --- //
...
module.exports = mongoose.model(config.collB2BEuLeadsStsLcs, schema);
// --- End: B2B Partner End Users Leads Status Lifecycles Schema --- //
