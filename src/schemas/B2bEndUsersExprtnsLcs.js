...
// --- Begin: B2B Partner End Users Expirations Life Cycle Schema --- //
const schema = new Schema({
  _id: {type: String, default: uuidv4()},
  euExprtn: {type: String, required: true, index: true},
...
module.exports = mongoose.model(config.collB2bEndUsersExprtnsLcs, schema);
// --- End: B2B Partner End Users Expirations Life Cycle Schema --- //
